...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train texture expert anti-spoofing model.")
    parser.add_argument(
        "--data_root",
        default="data",
    ...
    parser.add_argument(
        "--save_dir", default="checkpoints/texture_expert", help="Directory to save checkpoints."
    )
