...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train frequency expert anti-spoofing model.")
    parser.add_argument(
        "--data_root",
        default="data",
    ...
    parser.add_argument(
        "--save_dir", default="checkpoints/frequency_expert", help="Directory to save checkpoints."
    )
